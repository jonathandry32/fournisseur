                    ...
                    <li class="nav-item">
                      ...
                      <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                          ...
                          <li class="nav-item"> <a class="nav-link" href="{{ route('role.new')}}">Creation role</a></li>
                          {{-- @endcan --}}
                          <li class="nav-item"> <a class="nav-link" href="{{ route('role.attributPermissionToRole')}}">Attribution permission</a></li>
                          <li class="nav-item"> <a class="nav-link" href="{{ route('role.attributRoleUser')}}">Attribution Rôle aux User</a></li>
                          <li class="nav-item"> <a class="nav-link" href="{{ route('role.list')}}">list</a></li>
                        </ul>
                      </div>
                    </li>
            @endrole
